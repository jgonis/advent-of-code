...
(test problem1
  (let ((p1path (merge-pathnames 
                 #P"local-projects/advent-of-code/2018/p1input.txt"
                 ql:*quicklisp-home*)))
...
(test problem2
  (let ((p2path (merge-pathnames  
                 #P"local-projects/advent-of-code/2018/p2input.txt"
                 ql:*quicklisp-home*)))
    (is (= 6225 (aoc-18:problem2-1 p2path)))
    (is (string= "revtaubfniyhsgxdoajwkqilp" 
                 (aoc-18:problem2-2 p2path)))))

(test problem3
  (let ((p3path (merge-pathnames  
                 #P"local-projects/advent-of-code/2018/p3input.txt"
                 ql:*quicklisp-home*)))
